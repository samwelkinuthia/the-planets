class GalaxiesController < ApplicationController
  ...
  def destroy
    @galaxy.destroy
    respond_to do |format|
      format.html { redirect_to galaxies_path, notice: 'Galaxy was successfully deleted.' }
  ...
  private
    ...
    def galaxy_params
      params.require(:galaxy).permit(:name, :shape, :image, :size, :supercluster_id)
    end
end
